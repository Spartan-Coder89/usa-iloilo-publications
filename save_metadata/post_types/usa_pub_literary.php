...
/**
 *  Save updates on literary article metadata
 */
add_action( 'save_post_usa_pub_literary', 'usa_pub_update_literary_article_metadata' );
function usa_pub_update_literary_article_metadata( $post_id ) {
