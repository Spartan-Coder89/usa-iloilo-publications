...
/**
 *  Save updates on feature article metadata
 */
add_action( 'save_post_usa_pub_feature', 'usa_pub_update_feature_article_metadata' );
function usa_pub_update_feature_article_metadata( $post_id ) {
